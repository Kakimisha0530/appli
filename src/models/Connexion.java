...
public class Connexion implements Serializable {
    ...
    private transient static final String FILE_NAME = LocalConfig.CONTEXT_PATH + "planningDB";

    private String url = "jdbc:mysql://localhost/planning";
    private String login = "root";
    private String password = "shasha";
    ...
    String condition, String orderBy, String limit) throws SQLException {
        Statement transmission = connect.createStatement();
        ResultSet result = null;
        String req = "SELECT " + colonnes(donnees) + " FROM " + table;
    ...
    String condition) throws SQLException {
        return select(table, donnees, condition, null, null);
    }
    ...
    public ResultSet selectObject(String table, String condition, String orderBy, String limit) throws SQLException {
        Vector<String> donnees = new Vector<String>();
        donnees.add("*");
        return select(table, donnees, condition, orderBy, limit);
    }
     ...
     */
    /**
     * permet de compter le nomre de ligne d'une table de la bdd
     *
     * @param table
     * @param condition
     * @return
    ...
    public static String makeQuery(Object o) {
        ArrayList<Class<?>> chaine = new ArrayList<>();
